...
const ControllerPrepare     = require('./../helper/controller/controllerPrepare');
...
class Worker extends SCWorker
{
    ...
    async run()
    {
        ...
        this._controllerPrepare = new ControllerPrepare(this._zc,this);
        await this._controllerPrepare.prepare();
    ...
    getControllerPrepare()
    {
        return this._controllerPrepare;
    }
