...
class ZationConfig
{
    constructor(starterConfig,workerTransport = false)
    {
        ...
        if(!workerTransport)
        {
            ...
            this._mainConfig[Const.Main.KEYS.WORKERS] = Const.Main.OPTIONS.AUTO;
    ...
    isService(key)
    {
        return this._serviceConfig[key] !== undefined;
    }
    ...
    isEvent(key)
    {
        return this._eventConfig[key] !== undefined;
    }
    ...
    _loadUserDataLocations()
    {
        ...
        this._loadZationConfigLocation(Const.Main.KEYS.SERVICE_CONFIG,'service.config');
