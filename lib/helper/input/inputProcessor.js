    ...
    static processInput(task, controller)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if(isArray)
                {
                    processedData = InputProcessor._processInputArray(input,controllerInputKeys,controllerInput);
                }
                else
                {
                    processedData = InputProcessor._processInputObject(controllerInput,input);
                }
