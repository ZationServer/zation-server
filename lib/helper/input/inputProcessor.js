    ...
    static processInput(task, controller)
    {
        ...
        else
        {
            ...
            else
            {
                if(isArray)
                {
                    InputProcessor._processInputArray(input,controllerInputKeys,controllerInput,useInputValidation);
                }
                else
                {
                    InputProcessor._processInputObject(controllerInput,input,useInputValidation);
                }
