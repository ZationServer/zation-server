...
class ChAccessEngine
{
    ...
    //Part Access
    static _hasAccessTo(value,socket,smallBag,info = {})
    {
        let access = false;
    ...
    static hasAccessToPub(socket, channelConfig, smallBag, info = {})
    {
    ...
    static checkAccessSubCustomIdCh(socket,trySubName,smallBag,zc)
    {
        //return error
    ...
    static checkAccessPubCustomIdCh(socket,tryPubName,smallBag,zc)
    {
        //return error
    ...
    static checkAccessSubCustomCh(socket,trySubName,smallBag,zc)
    {
        //return error
    ...
    static checkAccessPubCustomCh(socket,tryPubName,smallBag,zc)
    {
        //return error
    ...
    static checkSocketCustomChAccess(socket, worker)
    {
