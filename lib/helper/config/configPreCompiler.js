...
class ConfigPeCompiler
{
    ...
    _prepareControllerDefaults()
    {
        ...
        let cd = this._zc.getApp(Const.App.CONTROLLER_DEFAULT);
    ...
    _preCompileController()
    {
        ...
        if(!this._zc.getApp(Const.App.CONTROLLER))
        {
            this._zc.getAppConfig()[Const.App.CONTROLLER] = {};
        }
        ...
        for(let k in controller)
        {
            if(controller.hasOwnProperty(k))
            {
                ...
                if(controller[k][Const.App.CONTROLLER_NAME] === undefined)
                {
                    controller[k][Const.App.CONTROLLER_NAME] = k;
                }
