...
Structures.Main[Const.Main.KEYS.SERVICES]                = {types : ['object'],isOptional : true};
Structures.Main[Const.Main.KEYS.CUSTOM_SERVICES]         = {types : ['object'],isOptional : true};
...
Structures.Services = {};
Structures.Services[Const.Main.SERVICES.MYSQL]                  = {types : ['object'],isOptional : true};
Structures.Services[Const.Main.SERVICES.NODE_MAILER]            = {types : ['object'],isOptional : true};
Structures.Services[Const.Main.SERVICES.POSTGRES_SQL]           = {types : ['object'],isOptional : true};
Structures.Services[Const.Main.SERVICES.MONGO_DB]               = {types : ['object'],isOptional : true};
