...
Structures.ObjBody = {};
Structures.ObjBody[Const.App.INPUT.IS_ARRAY]                = {types : ['boolean'],isOptional : true};
Structures.ObjBody[Const.App.OBJECTS.PROPERTIES]            = {types : ['object'],isOptional : false};
Structures.ObjBody[Const.App.OBJECTS.COMPILE_AS]            = {types : ['function'],isOptional : true};
