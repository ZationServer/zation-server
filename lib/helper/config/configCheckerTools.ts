...
{
    static assertProperty(key,obj,types,isOptional,configName,configErrorBag,target = new Target())
    {
    ...
    static assertStructure(structure,obj,configName,configErrorBag,target = new Target())
    {
        let allowedKeys = [];
    ...
    static assertEqualsOne(values,searchValue,configName,configErrorBag,message,target = new Target())
    {
        let found = false;
