...
class ConfigChecker
{
   ...
   _checkChannelConfig()
   {
       ...
       {
           this._checkChannelItem(this._zc.getChannel(Const.Channel.KEYS.DEFAULTS),new Target('Default'));
       }
       ...
       if(typeof customChannel === 'object')
       {
           for(let channel in customChannel)
           {
               ...
               {
                   this._checkChannelItem(customChannel[channel],new Target(`Custom Channel: '${channel}'`));
               }
           }
       }
   }
   ...
   _checkControllerConfigs()
   {
       ...
       if (this._zc.isApp(Const.App.KEYS.CONTROLLER))
       {
           ...
           for(let cName in controller)
           {
               ...
               {
                   this._checkController(controller[cName],new Target(`Controller: '${cName}'`));
               }
           }
       }
       ...
       if (this._zc.isApp(Const.App.KEYS.CONTROLLER_DEFAULT))
       {
           ...
           this._checkController(controller,new Target(`ControllerDefault`));
       }
   }
