...
class InputChecker
{
    ...
    static createParamsAndCheck(task,controller)
    {
        ...
        let inputParamsCount = isArray ? inputParams.length : InputChecker._objectSize(inputParams);
        ...
        else
        {
            ...
            let paramsMissing = isArray ? InputChecker._getParamsMissingFromArray(inputParams,controllerParams,false) :
                InputChecker._getParamsMissingFromObject(inputParams,controllerParams,false);
            ...
            else
            {
                ...
                if(isArray)
                {
                    InputChecker._checkParamsWithAr+rayInput(paramData,processData);
                }
                else
                {
                    InputChecker._checkParamsWithObjectInput(paramData,processData);
                }
            }
        }
        return paramData;
