...
class SmallBag
{
    ...
    // noinspection JSUnusedGlobalSymbols
    publishToSpecifyUser(authId,eventName,data,cb)
    {
        this._exchangeEngine.publishInUserCh(authId,eventName,data,cb);
    }

    // noinspection JSUnusedGlobalSymbols
    publishToSpecifyUsers(authIds,eventName,data,cb)
    {
        this._exchangeEngine.publishInUserChannels(authIds,eventName,data,cb);
    }
