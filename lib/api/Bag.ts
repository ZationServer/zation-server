...
class Bag extends SmallBag
{
    ...
    constructor(shBridge : SHBridge,worker : Worker,authEngine : AuthEngine,tokenEngine : TokenEngine,inputWrapper : InputWrapper)
    {
    ...
    {
        return await this._tokenEngine.setTokenVariable({key : value},false);
    }

    // noinspection JSUnusedGlobalSymbols
    getTokenVariable(key)
    {
        return this._tokenEngine.getTokenVariable(key);
    }
    ...
    getProtocol()
    {
        return this._authEngine.getProtocol();
    }

    // noinspection JSUnusedGlobalSymbols
    isSocketProtocol()
    {
        return this._shBridge.isWebSocket();
    }
    ...
    getSubChannels()
    {
        return this._channelEngine.getSubChannels();
    }

    // noinspection JSUnusedGlobalSymbols
    kickFromCustomIdCh(name,id = '')
    {
        return this._channelEngine.kickCustomIdChannel(name,id);
    }

    // noinspection JSUnusedGlobalSymbols
    kickFromCustomCh(name)
    {
        return this._channelEngine.kickCustomChannel(name);
    }
