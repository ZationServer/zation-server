...
const DataboxConfig = {};
DataboxConfig[nameof<DataboxConfig>(s => s.access)]           = {types : ['string','function','object','array'],isOptional : true};
DataboxConfig[nameof<DataboxConfig>(s => s.notAccess)]        = {types : ['string','function','object','array'],isOptional : true};
