...
Structures.AppController[Const.App.CONTROLLER.WS_ACCESS]     = {types : ['boolean'],isOptional : true};
...
Structures.AppController[Const.App.CONTROLLER.INPUT_ALL_ALLOW]   = {types : ['boolean'],isOptional : true};
...
//Keys here were not delete by using a validationGroup!
Structures.InputBodyMainKeys = {};
Structures.InputBodyMainKeys[Const.App.INPUT.IS_OPTIONAL]             = {types : ['boolean'],isOptional : true};
...
Structures.ChannelConfig[Const.Channel.KEYS.CUSTOM_ID_CHANNELS]      = {types : ['object'],isOptional : true};
...
Structures.ChannelItem[Const.Channel.CHANNEL.PUBLISH]       = {types : ['function','boolean','number','array','string'],isOptional : true};
Structures.ChannelItem[Const.Channel.CHANNEL.SUBSCRIBE]     = {types : ['function','boolean','number','array','string'],isOptional : true};
Structures.ChannelItem[Const.Channel.CHANNEL.NOT_SUBSCRIBE] = {types : ['function','boolean','number','array','string'],isOptional : true};
Structures.ChannelItem[Const.Channel.CHANNEL.NOT_PUBLISH]   = {types : ['function','boolean','number','array','string'],isOptional : true};
...
Structures.AppArray = {};
Structures.AppArray[Const.App.INPUT.ARRAY]                    = {types : ['object'],isOptional : true};
Structures.AppArray[Const.App.ARRAY.MIN_LENGTH]               = {types : ['number'],isOptional : true};
Structures.AppArray[Const.App.ARRAY.MAX_LENGTH]               = {types : ['number'],isOptional : true};
Structures.AppArray[Const.App.ARRAY.LENGTH]                   = {types : ['number'],isOptional : true};
Structures.AppArray[Const.App.INPUT.IS_OPTIONAL]              = {types : ['boolean'],isOptional: true};

Structures.ArrayShortCutSpecify = {};
Structures.ArrayShortCutSpecify[Const.App.ARRAY.MIN_LENGTH]               = {types : ['number'],isOptional : true};
Structures.ArrayShortCutSpecify[Const.App.ARRAY.MAX_LENGTH]               = {types : ['number'],isOptional : true};
Structures.ArrayShortCutSpecify[Const.App.ARRAY.LENGTH]                   = {types : ['number'],isOptional : true};
