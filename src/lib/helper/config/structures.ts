...
StarterConfig[nameof<StarterConfig>(s => s.appConfig)]     = {types : ['string','object'],isOptional : true};
StarterConfig[nameof<StarterConfig>(s => s.serviceConfig)] = {types : ['string','object'],isOptional : true};
StarterConfig[nameof<StarterConfig>(s => s.errorConfig)]   = {types : ['string','object'],isOptional : true};
StarterConfig[nameof<StarterConfig>(s => s.eventConfig)]   = {types : ['string','object'],isOptional : true};
StarterConfig[nameof<StarterConfig>(s => s.channelConfig)] = {types : ['string','object'],isOptional : true};
StarterConfig[nameof<StarterConfig>(s => s.mainConfig)]    = {types : ['string','object'],isOptional : true};
...
const AppArray = {};
AppArray[nameof<ArrayPropertyConfig>(s => s.array)]             = {types : ['object'],isOptional : true};
